...
export const ImageSkeleton = () => {
  return (
    <div
      role="status"
      className="h-full w-full animate-pulse space-y-8 rounded-tl-md rounded-tr-md !object-contain md:flex md:items-center md:space-x-8 md:space-y-0 rtl:space-x-reverse"
    >
